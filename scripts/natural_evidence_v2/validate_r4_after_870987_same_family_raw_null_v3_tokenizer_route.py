...
DEFAULT_CONFIG = ROOT / "configs/natural_evidence_v2/r4_after_870987_same_family_raw_null_v3_tokenizer_preflight_route.yaml"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate R4 same-family raw-null v3 tokenizer preflight route.")
...
def main() -> int:
    ...
    if cfg.get("schema_name") != "natural_evidence_v2_r4_after_870987_same_family_raw_null_v3_tokenizer_preflight_route_v1":
        errors.append("schema_name mismatch")
    if cfg.get("route_id") != "r4_after_870987_same_family_raw_null_v3_tokenizer_preflight_v1":
    ...
    row_manifest = read_json(root_path(source.get("v3_row_bank_manifest", ""), errors, "v3 row bank manifest"))
    ...
    if failed_review.get("status") != "FAIL_R4_AFTER_870987_SAME_FAMILY_RAW_NULL_V2_875471_FORBIDDEN_RESIDUAL_NO_ADOPT":
        errors.append("875471 review must remain no-adopt")
    ...
    for fragment in (
        "ROUTE_CONFIG=configs/natural_evidence_v2/r4_after_870987_same_family_raw_null_v3_tokenizer_preflight_route.yaml",
        ...
        "MAX_ROWS=65536",
        "ROUTE_VALIDATOR=scripts/natural_evidence_v2/validate_r4_after_870987_same_family_raw_null_v3_tokenizer_route.py",
    ...
    status = (
        ...
        if not errors
        else "FAIL_R4_AFTER_870987_SAME_FAMILY_RAW_NULL_V3_TOKENIZER_ROUTE_PLAN_ONLY_NO_SUBMIT"
    )
    ...
    summary = {
        "schema_name": "natural_evidence_v2_r4_after_870987_same_family_raw_null_v3_tokenizer_route_validation_v1",
        "status": status,
        "errors": errors,
    ...
    write_text_new(
        ...
        "# R4 Same-Family Raw-Null V3 Tokenizer Route Validation\n\n"
        f"Status: `{status}`\n\n"
        f"Errors: {len(errors)}\n\n"
