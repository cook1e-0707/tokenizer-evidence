...
DEFAULT_CONFIG = ROOT / "configs/natural_evidence_v2/r4_after_870987_same_family_raw_null_v4_tokenizer_preflight_route.yaml"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate R4 same-family raw-null v4 tokenizer preflight route.")
...
def main() -> int:
    ...
    if cfg.get("schema_name") != "natural_evidence_v2_r4_after_870987_same_family_raw_null_v4_tokenizer_preflight_route_v1":
        errors.append("schema_name mismatch")
    if cfg.get("route_id") != "r4_after_870987_same_family_raw_null_v4_tokenizer_preflight_v1":
    ...
    row_manifest = read_json(root_path(source.get("v4_row_bank_manifest", ""), errors, "v4 row bank manifest"))
    ...
    if failed_review.get("status") != "FAIL_R4_AFTER_870987_SAME_FAMILY_RAW_NULL_V3_875777_FORBIDDEN_RESIDUAL_NO_ADOPT":
        errors.append("875777 review must remain no-adopt")
    ...
    for fragment in (
        "ROUTE_CONFIG=configs/natural_evidence_v2/r4_after_870987_same_family_raw_null_v4_tokenizer_preflight_route.yaml",
        ...
        "MAX_ROWS=65536",
        "ROUTE_VALIDATOR=scripts/natural_evidence_v2/validate_r4_after_870987_same_family_raw_null_v4_tokenizer_route.py",
    ...
    if entry is None:
        ...
        for fragment in (
            "r4_after_870987_same_family_raw_null_v4_tokenizer_preflight_route.yaml",
            "r4_after_870987_same_family_raw_null_v4_row_bank_plan_20260524/row_allocation_rows.jsonl",
            "validate_r4_after_870987_same_family_raw_null_v4_tokenizer_route.py",
        ):
    ...
    status = (
        ...
        if not errors
        else "FAIL_R4_AFTER_870987_SAME_FAMILY_RAW_NULL_V4_TOKENIZER_ROUTE_PLAN_ONLY_NO_SUBMIT"
    )
    ...
    summary = {
        "schema_name": "natural_evidence_v2_r4_after_870987_same_family_raw_null_v4_tokenizer_route_validation_v1",
        "status": status,
        "errors": errors,
