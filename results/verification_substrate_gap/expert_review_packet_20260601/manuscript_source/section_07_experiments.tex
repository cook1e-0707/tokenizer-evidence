...
accept regions are optimization targets.  A later proxy readability audit over
60 guided rewrite/graft examples found 0/60 passing rows under simple surface
checks for length ratio, token overlap, sentence punctuation, isolated
fragments, and known broken-graft markers.  This strengthens the limitation:
the current guided attack demonstrates predicate optimizability, not
naturalness-preserving rewriting.
