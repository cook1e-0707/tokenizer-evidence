...
This thesis is deliberately narrower than several stronger verification goals:
...
payload diversity, model-family general verification, and ownership proof are
outside the evidence scope of the current artifacts.  The affirmative evidence
is a trace-bound provider-side diagnostic; the negative evidence is a public
final-text observability and spoofing diagnostic.
