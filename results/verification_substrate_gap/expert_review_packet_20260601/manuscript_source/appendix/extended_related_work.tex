...
credential, statement, proof, or transcript is available.  Cryptographic
provenance is outside this manuscript's evidence scope; these systems mark
the difference between proof-bearing substrates and ordinary copied natural
text.
...
\midrule
Private-key text watermarks & Final generated text plus detector key & Distributional detection or keyed detection & Text remains sufficiently unmodified; detector has key & Closest final-text substrate; current artifacts provide no watermark-success result \\
