...
```text
results/natural_evidence_v1/status/hermes_reports/20260508_1012_scheduled_tick_notification.json
...
latest Hermes report permits only a new explicit artifact-only
