...
codex_report:
`results/natural_evidence_v1/status/hermes_reports/20260509_0054_scheduled_tick_codex_report.md`
...
next_allowed_action:
Review the restricted step-label density audit plan. If approved, implement or review exactly one Chimera Slurm wrapper for base-Qwen model-output density audit on the 256 planned 16-step prompts. Do not start WP4 or training.
