# R3.2 submission blocker: 2026-05-11 13:34Z

## Decision

`BLOCK_R3_2_SUBMISSION_LOCAL_ALLOWLIST_UNSAFE_NO_SLURM`

The 2026-05-11 13:33Z Hermes TG/email notification path succeeded, but the
R3.2 Slurm submission is still not safe. The local allowlist has a forbidden
Llama GPU entry enabled:
...
results/natural_evidence_v1/status/hermes_reports/20260511_1333_scheduled_tick.md
results/natural_evidence_v1/status/hermes_reports/20260511_1333_scheduled_tick_notification.json
...
positive claim, or login-node CPU/GPU work was started.
