...
codex_report:
`results/natural_evidence_v1/status/hermes_reports/20260508_2324_scheduled_tick_codex_report.md`
...
next_allowed_action:
Prepare artifact-only context-specific WP3 mass scoring plan from balanced template response detections: extract prefix_before_candidate at detected structural/template slots, audit casing variants separately, then submit any model scoring through Chimera Slurm. No training, generation, Qwen E2E, Llama, same-family null, sanitizer, FAR, or positive claim.
