...
timestamp_utc: `2026-05-11T12:33:46Z`

phase: `V2_R3_QWEN_LOCKED_SCALE_ROUTE_APPROVED`

controlling_tick:
`results/natural_evidence_v1/status/hermes_reports/20260511_1233_scheduled_tick.md`

notification_json:
`results/natural_evidence_v1/status/hermes_reports/20260511_1233_scheduled_tick_notification.json`
...
The 12:33 Hermes tick authorizes enabling exactly one reviewed R3.2 allowlist
...
submission preflight remains unsafe because the local allowlist still has an
enabled forbidden Llama GPU entry while `llama_allowed=false`.
