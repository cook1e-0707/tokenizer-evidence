...
observed_red_flag:
The pre-Codex Hermes tick reported a pending `llama-v2` Slurm job in
`active_jobs`. Llama work is forbidden in the current phase; this worker did
not inspect, submit, cancel, or otherwise act on that job.
