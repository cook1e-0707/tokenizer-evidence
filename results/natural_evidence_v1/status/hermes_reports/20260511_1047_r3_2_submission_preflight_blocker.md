...
Timestamp UTC: 2026-05-11T10:47:00Z
...
`results/natural_evidence_v1/status/hermes_reports/20260511_1047_scheduled_tick_notification.json`
...
satisfied, but submission is still not safe from the current recorded state.

## Blocking evidence

- Local `configs/natural_evidence_v2/run_allowlist.yaml` still has enabled
  `llama_v2_wp6_e2e_eval` while `llama_allowed=false`.
- The compact state still records the R3.2 submission preflight as unsafe after
  the 2026-05-11T10:32 blocker.
- No local repair record after the 2026-05-11T10:32 blocker was found in the
  compact state or gate files before this tick.
