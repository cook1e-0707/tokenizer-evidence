...
6. `B1` + `B2`: minimal baseline comparison package is prepared as pending artifacts; run only after real calibration scores freeze thresholds and placeholder external baselines are integrated or explicitly left unavailable.
