...
| R1 | Cross-family replication | local R1 package is staged for Llama-3.1-8B-Instruct with payloads `U00/U03/U12/U15`, seeds `17/23/29`, and B2; Llama tokenizer source catalog exists but frozen catalog is still required before launch | authenticated Llama tokenizer freeze, committed frozen catalog, Chimera train/eval, and paper-facing artifacts | `configs/experiment/scale/r1/exp_train__llama3_1_8b__r1_replication_v1.yaml`; `configs/experiment/scale/r1/exp_eval__llama3_1_8b__r1_replication_v1.yaml`; `configs/reporting/r1_llama3_1_8b_replication_v1.yaml`; `results/tables/r1_replication.csv`; `results/tables/r1_replication.tex`; `results/processed/paper_stats/r1_summary.json` | Local prepare, Chimera later | Blocked until `configs/data/frozen/real_pilot_catalog__llama3_1__v1.yaml` is generated by strict authenticated freeze | P1 |
