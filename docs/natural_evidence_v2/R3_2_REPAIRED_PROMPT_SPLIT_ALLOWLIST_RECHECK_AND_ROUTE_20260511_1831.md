# R3.2 Repaired Prompt Split Allowlist Recheck and Route: 2026-05-11 18:31Z

## Scope

Artifact-only recheck under the repaired R3.2 prompt split contract.
...
```text
results/natural_evidence_v2/status/r3_2_allowlist_recheck_repaired_prompt_split_20260511_1831.json
results/natural_evidence_v2/status/r3_2_repaired_prompt_split_single_job_route_20260511_1831.json
```
