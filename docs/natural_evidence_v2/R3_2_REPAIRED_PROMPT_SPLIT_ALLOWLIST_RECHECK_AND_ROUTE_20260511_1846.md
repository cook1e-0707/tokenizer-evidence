# R3.2 Repaired Prompt Split Allowlist Recheck and Route: 2026-05-11 18:46Z

## Scope

Artifact-only recheck under the repaired R3.2 prompt split contract, prompted by
the 2026-05-11 18:46Z Hermes supervisor tick.
...
```text
results/natural_evidence_v2/status/r3_2_allowlist_recheck_repaired_prompt_split_20260511_1846.json
results/natural_evidence_v2/status/r3_2_repaired_prompt_split_single_job_route_20260511_1846.json
```
